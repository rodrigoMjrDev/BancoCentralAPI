...
public class DadosDividaLiquidaRepositoryTest {
    ...
    void save_PersistDivida_WhenSuccessful(){
        DadosDividaLiquida dividaToBeSaved = DividaLiquidaBCCreator.createDividaToBeSaved();

        DadosDividaLiquida dividaSaved = this.dividaLiquidaBCRepository.save(dividaToBeSaved);
    ...
    void save_UpdatesDivida_WhenSuccessful(){
        ...
        DadosDividaLiquida dividaUpdated = this.dividaLiquidaBCRepository.save(dividaSaved);
    ...
    void delete_RemovesDivida_WhenSuccessful(){
        ...
        Optional<DadosDividaLiquida> dividaOptional = this.dividaLiquidaBCRepository.findById(dividaSaved.getId());
    ...
    void findByValor_ReturnsListOfDivida_WhenSuccessful(){
        ...
        List<DadosDividaLiquida> divida = this.dividaLiquidaBCRepository.findByValor(valor);
    ...
    void findByValor2_ReturnsListOfDivida_WhenSuccessful(){
        ...
        List<DadosDividaLiquida> divida = this.dividaLiquidaBCRepository.findByValor2(valor);
    ...
    void findByData_ReturnsListOfDivida_WhenSuccessful(){
        ...
        List<DadosDividaLiquida> divida = this.dividaLiquidaBCRepository.findByData(data);
    ...
    void findByDataBetween_ReturnsListOfDivida_WhenSuccessful(){
        ...
        List<DadosDividaLiquida> divida = this.dividaLiquidaBCRepository.findByDataBetween(data, data);
    ...
    void findByValor_ReturnsEmptyList_WhenDividaIsNotFound(){
        List<DadosDividaLiquida> divida = this.dividaLiquidaBCRepository.findByValor(100.0);
